...
export default {
  ...
  logo: '/logo-2.svg', // 'logo-component', // or '/logo.svg' for regular image
  googleAnalytics: {
    on: true,
    id: 'G-GBTXFYB4KH'
  },
  ...
  disqus: {
    ...
    siteShortName: 'christophe-hubert' // 'blog-danielkelly-io'
  },
  ...
  newsletter: {
    ...
    mailchimp: {
      on: true,
      formAction:
        'https://gmail.us1.list-manage.com/subscribe/post?u=6b6e07bf7e61e667b128b3bc3&amp;id=407db36d16'
    },
    custom: {
      on: false,
      formAction: ''
